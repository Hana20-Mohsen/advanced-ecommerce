...
export default function Profile() {
  ...
  return (
    <div className='bg-grad  d-flex justify-content-center align-items-center position-relative' >
      <div className=' '>
      ...
      <div className=' h-50   align-content-center '>
        <div className="container  ">
          ...
          <div className={`Gray-Color  container text-white p-4 main-color-border rounded-3 ${styles.profileData_holder}`}>
